...
<head>
    ...
    <title>Job Portal Chandan Ojha</title>
...
<body>
                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">Job Seeker <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li> <a href= "Login & Sign Up/index.php" > Sign Up/Login</a></li>
                                                    <li><a href="elements.html">Post Resume</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Employer <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="blog.html">Sign Up/Login</a></li>
													<li><a href="Job Post\Post Jobs.html">Post Jobs</a></li>
													<li><a href="single-blog.html">Search Resume</a></li>
													
                                                </ul>
                                            </li>
											 <li><a href="#">Career Resources <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="blog.html">Career Guide</a></li>
                                                    <li><a href="single-blog.html">Interview Tips</a></li>
													<li><a href="single-blog.html">Resume Writing Tips</a></li>
													<li><a href="single-blog.html">Cover Letter</a></li>
    ...
    <div class="slider_area">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="slider_text">
                            ...
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">The Easiest Way To Get Your Dream Job</p>
        ...
        <div class="ilstration_img wow fadeInRight d-none d-lg-block text-right" data-wow-duration="1s" data-wow-delay=".2s">
            <img src="img/banner/img6.jpg" alt="">
        </div>
    </div>
    <!-- slider_area_end -->
        ...
        <div class="container">
            <div class="row cat_search">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="single_input">
                        <select class="wide" >
                            <option data-display="Select Region">Select Region</option>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="single_input">
                        <select class="wide">
                            <option data-display="Select Job Type">Select Job Type</option>
                            ...
                            <div class="jobs_left d-flex align-items-center">
                                ...
                                <div class="jobs_conetent">
                                    ...
                                    <div class="links_locat d-flex align-items-center">
                                        <div class="location">
                                            <p> <i class="fa fa-map-marker"></i> Mirpur-01, Dhaka</p>
                                        </div>
                                        <div class="location">
                        ...
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                ...
                                <div class="jobs_conetent">
                                    ...
                                    <div class="links_locat d-flex align-items-center">
                                        <div class="location">
                                            <p> <i class="fa fa-map-marker"></i> Dhanmondi, Dhaka</p>
                                        </div>
                                        <div class="location">
                                            <p> <i class="fa fa-clock-o"></i> Part-time</p>
                                        </div>
                        ...
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                ...
                                <div class="jobs_conetent">
                                    ...
                                    <div class="links_locat d-flex align-items-center">
                                        <div class="location">
                                            <p> <i class="fa fa-map-marker"></i> Farmgate, Dhaka</p>
                                        </div>
                                        <div class="location">
            ...
            <div class="row">
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="single_company">
                        ...
                        <a href="jobs.html"><h3>Walton</h3></a>
                        <p> <span>50</span> Available position</p>
                    </div>
                </div>
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="single_company">
                        ...
                        <a href="jobs.html"><h3>Square</h3></a>
                        <p> <span>50</span> Available position</p>
                    </div>
                </div>
                <div class="col-lg-4 col-xl-3 col-md-6">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            ...
                            <div class="socail_links">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/chandan.ojha.9847867" target="_blank">
